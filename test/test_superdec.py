...
def main():
    ...
    # 006_mustard_bottle 002_master_chef_can/ 035_power_drill
    path_to_input = "assets/ycb_datasets/002_master_chef_can/035_power_drill.obj"  # can be .obj, .ply, .stl, etc.
    z_up = False  # specify if your input point cloud/mesh is in z-up orientation
    normalize = True  # whether to normalize input
    lm_optimization = True  # use LM optimization
