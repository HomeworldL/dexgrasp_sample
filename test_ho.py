...
if __name__ == "__main__":
    ...
    mjho = MjHO(obj_info, xml_path, visualize=True)
    ...
    stp = 0
    c1 = np.array([0, 0.8, 0.8, 0, 0.8, 0.8, 0, 0.8, 0, 0.8, 1.6, 0.0, 0.3])
    c2 = np.array([0, 1.5, 1.5, 0, 1.5, 1.5, 0, 1.3, 0, 1.3, 1.6, 0.3, 0.5])
    while mjho.viewer.is_alive:
        if stp < 3000:
            mjho.step(ctrl=c1)
        else:
            mjho.step(ctrl=c2)
